...
/**
 * Created with IntelliJ IDEA. User: krzyh Date: 10/30/13 Time: 7:43 AM To change this template use File | Settings | File Templates.
 */
public class FileSizeTest {
    private final static char DECIMAL_SEPARATOR = DecimalFormatSymbols.getInstance(Locale.getDefault()).getDecimalSeparator();
    ...
    Object[][] testToStringDataProvider() {
        return new Object[][] {
            ...
            {1536L, "1" + DECIMAL_SEPARATOR + "5 KB"},
            {1025L, "1 KB"},
            {1024L * 1024 - 1, "1024 KB"}
