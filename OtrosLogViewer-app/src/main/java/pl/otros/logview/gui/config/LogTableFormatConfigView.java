...
public class LogTableFormatConfigView extends AbstractConfigView implements InMainConfig {
  ...
  public LogTableFormatConfigView() {
    ...
    exportToolbar.add(new AbstractAction("Export to file") {
      @Override
      public void actionPerformed(ActionEvent actionEvent) {
        exportToFile();
      }
    ...
    importToolbar.add(new AbstractAction("Import from clipboard") {
      @Override
      public void actionPerformed(ActionEvent actionEvent) {
        try {
          importFromClipboard();
    ...
    importToolbar.add(new AbstractAction("Import from file") {
      @Override
      public void actionPerformed(ActionEvent actionEvent) {
        importFromFile();
      }
